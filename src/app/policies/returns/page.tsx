  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 sm:py-14">
      ...
      <p className="text-sm text-text-gray mb-4">
        This policy is currently under review. Return eligibility, timelines, and procedures will be published once confirmed.
      </p>
      <div className="border-t border-charcoal/10 pt-6 mt-6">
        ...
        <ul className="space-y-1.5 text-sm text-text-gray list-disc list-inside">
          <li>Preorder cancellation eligibility</li>
          <li>Personalized item returnability</li>
          <li>Return window</li>
          <li>Condition requirements</li>
          <li>Return-shipping responsibility</li>
          <li>Refund timing</li>
          <li>Damaged-item procedure</li>
          <li>Exchange availability</li>
          <li>Restocking fees (if any)</li>
        </ul>
      </div>
    </div>
  );
